  ...
  <table style="width: 80%; border-collapse: collapse; margin: 0 auto;">
    <tbody>
      <tr>
        ...
        <td colspan="5" style="padding: 10px;">Sistemas Distribuidos</td>
      </tr>
      <tr>
        <td style="padding: 10px; font-weight: bold;">LABORATORIO:</td>
        <td colspan="5" style="padding: 10px;">Threads in Java</td>
      </tr>
      <tr>
        <td style="padding: 10px; font-weight: bold;">FECHA DE PRESENTACIÓN:</td>
        <td style="padding: 10px;">23 de abril, 2026</td>
        <td style="padding: 10px; font-weight: bold;">AÑO LECTIVO:</td>
        <td style="padding: 10px;">2026 A</td>
      ...
      <tr>
        <td colspan="6" style="padding: 10px;">Maribel Molina Barriga</td>
      </tr>
      <tr>
